// Wait for the entire page and all scripts to load before running any code
window.addEventListener("load", () => {
  ...
  function showArtistDetail(artistName) {
    ...
    const imagePath = artistImages[artistName]
      ...
      : `https://placehold.co/200x200/374151/d1d5db?text=${artistName.charAt(
          0
        )}`;
    ...
    const songsByArtist = fakeSongs.filter(
